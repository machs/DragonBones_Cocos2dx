...
#include "auto/jsb_cocos2dx_coustom_auto.hpp"
...
bool AppDelegate::applicationDidFinishLaunching()
{
    ...
    if(!glview) {
        ...
        glview = cocos2d::GLViewImpl::create("tojsbs");
#else
        glview = cocos2d::GLViewImpl::createWithRect("tojsbs", Rect(0,0,960,640));
#endif
	...
	//coustom
	sc->addRegisterCallback(register_all_cocos2dx_coustom);
